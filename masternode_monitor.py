...
def main(report_url, verbose=False):
    ...
    # Step 12: Restart server if uptime is greater than 3 days and not in quorum
    if in_quorum is False and po_se_penalty == 0 and float(run_command("awk '{print $1}' /proc/uptime", verbose)) > 3 * 86400:
